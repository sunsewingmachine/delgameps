...
// Features modern design with smooth animations, responsive layout, and enhanced visual hierarchy.
					...
					{qrUrl ? (
						<div className="text-center space-y-8">
							...
							{!isLoading && !imageError && qrUrl && (
								<div
									className={`hidden flex flex-col sm:flex-row gap-4 justify-center transition-all duration-500 ${
